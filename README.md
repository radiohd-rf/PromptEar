...
1. Скачать `PromptEar-v0.16.4.zip` со страницы [релизов](https://github.com/radiohd-rf/PromptEar/releases)
...
Требуется Python 3.10+ и интернет. На выходе — `PromptEar-v0.16.4.zip`
