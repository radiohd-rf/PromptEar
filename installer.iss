...
OutputBaseFilename=PromptEar_Setup_v0.9.2
...
DisableReadyPage=no
UninstallDisplayIcon={app}\li.ico
ChangesEnvironment=yes
SetupIconFile=li.ico
...
Source: "di.ico"; DestDir: "{app}"; Flags: ignoreversion
Source: "li.ico"; DestDir: "{app}"; Flags: ignoreversion
...
[Icons]
Name: "{autoprograms}\{#MyAppName}"; Filename: "{app}\run.vbs"; WorkingDir: "{app}"; IconFilename: "{app}\li.ico"
Name: "{autodesktop}\{#MyAppName}"; Filename: "{app}\run.vbs"; WorkingDir: "{app}"; Tasks: desktopicon; IconFilename: "{app}\li.ico"
